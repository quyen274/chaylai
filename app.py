...
scroll_position = st.sidebar.slider("Vị trí cuộn:", 0, len(st.session_state['data']) - zoom_level, 0)
...
# Simulate data and keep all historical records
st.session_state['data'] = simulate_new_data(st.session_state['data'])

# Prepare data for the chart
pivot_data = prepare_data(st.session_state['data'])
